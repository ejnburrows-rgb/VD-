    ...
    <footer className="bg-[#4A3728] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-6">
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-300 space-y-2 leading-relaxed">
              <p><strong className="text-white">Patente Pendiente:</strong> Tecnología de transcripción y análisis automatizado de décima espinela.</p>
              <p><strong className="text-white">Copyright:</strong> Todo el contenido, diseño, código fuente y algoritmos están protegidos por derechos de autor.</p>
              <p><strong className="text-white">Licencia:</strong> Creative Commons BY-NC-SA 4.0 (Uso no comercial con atribución)</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center space-y-2">
          <p className="text-xs text-gray-400">
            Desarrollado en Miami, Florida • En honor a{' '}
