      ...
      case "Adolfo Alfonso":
        return (
          <div className="space-y-4">
            ...
            <p>
              Adolfo Alfonso, decimista nato considerado uno de los mejores que ha tenido Cuba, a los catorce años ya interpretabas tangos. Pero después de admirar una controversia entre Angelito Valiente y el Indio Naborí, decidió dedicar su vida a cultivar la décima y el son montuno.
            </p>
            <p>
      ...
      case "Yoslay García":
        return (
          <div className="space-y-4">
            ...
            <p>
              Yoslay García nació in 1978, natural de Matanzas. Representa la continuidad del arte en las nuevas generaciones y se erige como uno de los poetas repentistas más importantes de su generación. La solidez de su décima lo distingue en el escenario.
            </p>
            <p>
      ...
      <Card className="p-6 cuban-card">
        ...
        <div className="text-[#5C4033] leading-relaxed space-y-4">
          <p>
            ...
            pensamiento en forma, emotion in structure, espontaneidad en permanencia.
          </p>
          <p>
