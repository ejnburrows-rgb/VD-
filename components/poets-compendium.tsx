...
const poets: Poet[] = [
  {
    ...
    subtitle: "Arquitecto del Continente",
    birth: "28 de diciembre de 1550 en Ronda, Málaga",
    death: "4 de febrero de 1624 en Madrid",
    biography: [
      "Vicente Gómez Martínez Espinel nació cuando el Siglo de Oro español comenzaba a brillar. Sacerdote, músico y escritor del Siglo de Oro español, su vida fue azarosa, llena de cambios, nunca fácil ni sosegada. Intentó ser soldado, fue escudero del Conde de Lemos, vivió con disipación en Sevilla. Los corsarios berberiscos lo apresaron; estuvo esclavizado en Argel hasta que los genoveses lo rescataron. Marchó después a Flandes, al ejército de Alejandro Farnesio.",
      "Poseía vastísima cultura. Dominaba el latín, siendo llamado \"el único poeta latino-castellano\", tradujo el Arte poética de Horacio y fue centro de la vida poética y artística de su época. En 1591 publicó \"Diversas Rimas\", obra que transformó definitivamente la poesía española cuando ensayó todas las estrofas posibles.",
      "Su legado perdurable cristalizó en la décima: diez versos octosílabos con arquitectura de rima abbaaccddc. Lope de Vega—quien fue su alumno—, Calderón de la Barca, Cervantes, Quevedo y Góngora la adoptaron inmediatamente. Pero aunque el poeta inventor fuera Vicente Espinel, la décima ya no es de él sino del pueblo cantor que la adoptó y la llevó a través del Atlántico hacia América Latina.",
  ...
  {
    name: "Plácido",
    subtitle: "Transparencia que Ilumina la Tragedia",
    birth: "1809 en La Habana",
    death: "28 de junio de 1844 (fusilado)",
    biography: [
      "Gabriel de la Concepción Valdés, hijo de un peluquero mulato y una bailarina española, fue depositado por la madre en la Casa de Beneficencia. Escribió su primer poema a los doce años—un soneto titulado \"La hermosa\".",
      "Huérfano y artesano, trabajó en múltiples oficios: carpintería, tipografía, fabricación de objetos de carey y platería. Su poesía, caracterizada por ingenuidad, simpatía, ternura y transparencia natural, elevó la décima a alturas líricas extraordinarias en el siglo XIX, convirtiéndose en uno de los representantes más importantes del Romanticismo cubano.",
      ...
      "Cintio Vitier escribió sobre él: \"La cubanía de Plácido, mucho más que en sus temas vernáculos, está en ese imponderable de ingenuidad y simpatía, de ternura y modestia, en esa transparencia natural de su voz manando cristalina; voz que al final trágico de su vida cobra acentos desgarradores de sencilla grandeza\"."
    ]
  },
  {
    ...
    biography: [
      ...
      "Sus décimas improvisadas combinaron recursos literarios sofisticados con rapidez de pensamiento, estableciendo un nivel de altura literaria sin precedentes para la décima oral. Debido a su ceguera, asumió una nueva arquitectura para la creación de sus poemas, dirigiéndose a lograr un peso mayor en el pensamiento abstracto. Sus borradores del aire—las improvisaciones aprendidas en la oralitura juvenil—se convirtieron en una literatura coloquial con evocaciones permanentes del paisaje cubano."
    ]
  },
  {
    ...
    biography: [
      "Ángel Miguel Valiente Rodríguez cursó la enseñanza elemental en una escuela pública de su barrio natal, interrumpiendo sus estudios para dedicarse al trabajo en vegas tabacaleras. Sin embargo, siempre fue un lector incansable, logrando cierta cultura autodidacta. Desde los ocho años improvisaba décimas. Ya en su juventud había logrado fama nacional a través de los programas radiales y la televisión.",
      "Su estilo era muy teatral: accionaba mucho con las manos, dramatizaba, ponía la misma energía en la voz que demostraba en sus gestos, y convencía al público con su efusividad gestual y paralingüística. Se llegó a decir que \"improvisaba más con las manos que con la boca\", aunque sus décimas eran de gran calidad literaria. Este estilo contrastaba notablemente con el del Indio Naborí, quien tenía una voz dulce, melodiosa, y cantaba con delicadeza.",
      "Fue protagonista de la célebre \"Controversia del Siglo\" junto al Indio Naborí. El primer encuentro ocurrió el 15 de junio de 1955 en el Casino Español de San Antonio de los Baños. La revancha en el estadio Campo Armada de San Miguel del Padrón reunió más de diez mil personas—un récord nunca superado en Cuba.",
      "El jurado decidió otorgar el triunfo al Indio Naborí, pero Angelito Valiente, con su caballerosidad característica, se acercó al jurado y dijo: \"Pongan ahí un cuarto jurado: yo mismo, que voto por Naborí\". Fue combatiente revolucionario y fundador y dirigente de los Comités de Defensa de la Revolución (CDR). Naborí y Valiente son considerados los más grandes repentistas cubanos del siglo XX."
    ]
  },
  {
    ...
    biography: [
      ...
      "Por la elevación y finura de sus décimas, este decimista es considerado \"el precursor de la décima moderna en Cuba\". Su famosa redondilla muestra su sensibilidad social: \"Anda por la calle un niño / huérfano hasta de la vida, / tiene la boca zurcida / por el hambre de un cariño\"."
    ]
  },
  {
    name: "Justo Vega",
  ...
  },
  {
    ...
    biography: [
      ...
      "Tan fuerte era la compenetración entre ambos trovadores que, después de muerto Justo Vega, Alfonso decidió no buscar otra pareja. A pesar de su trabajo con repentistas de gran talento como Emiliano Sardiñas, nunca volvió a experimentar la compenetración y empatía que sintiera con su compañero de varias décadas. Recibió el Premio Nacional de Música en 2004."
    ]
  },
  {
    name: "Chanito Isidrón",
    subtitle: "Humor como Arquitectura de Protesta",
    birth: "1903 en Calabazar de Sagua, Las Villas",
    death: "22 de julio de 1987",
    biography: [
      "Cipriano Isidrón Torres comenzó a improvisar desde los ocho años, siendo figura imprescindible en todas las fiestas. En 1931 abandonó las faenas agrícolas y se lanzó con su guitarra a recorrer los pueblos villaclareños, donde empezó a llamársele \"el elegante poeta de Las Villas\".",
      "En 1938, con \"Amores Montaraces\", se convirtió en fundador de la novela en décimas para ser cantada, escribiendo 123 décimas que totalizaban 1,230 versos. La novela cuenta la historia de Camilo y Estrella: \"Camilo, galán guajiro / que de amor canta con brío / sus décimas a una esquina / lanza con voz cristalina / y alma puesta en el gentío\".",
      "La época de oro de la radiodifusión cubana—años 40 y 50—lo tuvo como principal protagonista en programas estelares como \"Buscando el Príncipe de Punto Cubano\" (cuyo trono ocupó) y \"Dímelo cantando\". Su humor agresivo era como una explosión de rebeldía, de protesta, de anuncio de futuro.",
      "Considerado como el rey del punto cubano, fue uno de los mejores repentistas que ha tenido Cuba. La última proeza de Chanito Isidrón fue escribir la saga del héroe legendario Manuel García, Rey de los Campos de Cuba (1985)."
    ]
  },
  {
    name: "Omar Mirabal",
    ...
    biography: [
      ...
      "Su estilo poético tiene evidente ascendencia naboriana, donde destacan el gusto por el símil y las imágenes visuales. Es reconocido por su dominio técnico de la décima, por el celo con que cuida su lenguaje y por la plasticidad de sus imágenes. Los recursos expresivos mirabalianos tienen sus raíces en la más profunda tradición del habla campesina.",
      "Es dueño de un canto pausado, de gran limpieza enunciativa y de un estilo poético de gran profundidad. La popularidad que Omar Mirabal llegó a alcanzar en los años 80 lo convirtió en un eje estético de obligada referencia para las nuevas generaciones. Nadie como Omar ha encarnado en una sola persona el espíritu de Jesús Orta Ruiz (El Indio Naborí) y Francisco Riverón Hernández.",
      "Ha realizado controversias memorables con Pablo León, Angelito Valiente, Tuto García, Francisco Pereira \"Chanchito\", Jesusito Rodríguez, Rafael García, Hirán Fundora, Luis Paz \"Papillo\", Roberto García y Juan Antonio Díaz."
    ]
  },
  {
    name: "Tomasita Quiala",
    subtitle: "Victoria sobre la Oscuridad",
    birth: "29 de diciembre de 1960 en Arroyón de Flores, Holguín",
    death: "11 de junio de 2025",
    biography: [
      "Juana Tomasa Quiala Rojas fue conocida como \"La Reina del Repentismo\", \"La Ciega Maravillosa\" y \"Novia de Canarias\". Invidente desde su nacimiento, realizó estudios en la escuela para ciegos Varona Suárez. Desde niña Tomasita Quiala declamaba poemas sin saber que eran décimas.",
      "Su inicio en la improvisación fue inesperado cuando intervino espontáneamente en una canturía en defensa de otro poeta y lo hizo de tal manera que conquistó el aplauso del público. Invidente y mujer en un mundo generalmente masculino, tuvo que ganarse a pulso su lugar como una de las pocas mujeres dedicadas al repentismo en Cuba.",
      "En sus propias palabras: \"Uno se podrá cultivar, podrá estudiar, podrá leer libros y aprender, pero si no se tiene ese don, no podrá ser repentista\". Se destacó por su interpretación de la décima de pie forzado y en la controversia. Fue embajadora de la décima cubana en escenarios internacionales.",
      "Recibió el Premio Nacional de la Cultura Comunitaria (2004) y el Premio Iberoamericano Indio Naborí. Su legado permanece como símbolo de talento, autenticidad y superación, inspirando a generaciones de repentistas en Cuba y el mundo."
    ]
  },
  {
    name: "Julio Pablo Travieso Martínez (El Príncipe Pinareño)",
    subtitle: "Arquitecto de Versos en Tiempo Presente",
    birth: "Pinar del Río, Cuba",
    biography: [
      "Julio Pablo Travieso Martínez, conocido artísticamente como \"El Príncipe Pinareño\", representa la esencia misma de la escuela pinareña de repentismo. Su voz, forjada entre los campos de tabaco y el aire de la Sierra de los Órganos, posee una limpieza enunciativa que recuerda a los grandes clásicos, pero con una agilidad mental que lo sitúa en la vanguardia absoluta del siglo XXI.",
      "Se distingue por la elegancia en la construcción de la espinela, evitando el recurso fácil y buscando siempre la imagen que trascienda el instante. Su capacidad para manejar temas abstractos y filosóficos dentro del fragor de una controversia lo ha convertido en un referente para las nuevas generaciones que buscan elevar la décima improvisada a la categoría de alta literatura oral.",
      "Ha protagonizado controversias históricas que han quedado grabadas en la memoria del pueblo, donde su ingenio y respeto por el contrincante demuestran que el repentismo es, ante todo, un ejercicio de inteligencia compartida. Su legado no es solo el verso que queda en el aire, sino la dignidad con la que porta la tradición de su tierra natal."
    ]
  },
  {
    name: "Juan Antonio Díaz",
    subtitle: "Planos Imaginativos que Sorprenden",
    birth: "26 de mayo de 1970 en la finca \"La Caoba\", Pinar del Río",
    biography: [
      ...
      "Esta caracterización del maestro Naborí captura la esencia del estilo de Juan Antonio: capacidad de partir de lo concreto campesino para elevarse hacia construcciones imaginativas que asombran. Ha compartido escenario con maestros como Pablo León, Omar Mirabal, Luis Quintana, Leandro Camargo y Yoslay García.",
      "Su obra incluye tributos a figuras históricas del repentismo cubano, manteniendo viva la memoria de los grandes maestros. En controversias con Luis Quintana ha demostrado su dominio técnico de la décima improvisada. Su estilo combina la herencia campesina pinareña con técnica depurada y capacidad de crear imágenes poéticas que conectan lo rural con lo universal.",
      "Ha publicado el libro \"Mi dolor tuyo\", donde sus décimas aupan todo el sufrimiento y la esperanza del cubano."
    ]
  },
  {
    name: "Pablo León",
    ...
    biography: [
      ...
      "Entre sus versos memorables destaca la décima que condensa profundidad filosófica en construcción aforística: \"La muerte se hizo más fuerte / con la muerte de Martí, / porque sin muertos así / se moriría la muerte\". La paradoja productiva revela verdades que desafían lógica simple mientras mantienen estructura impecable."
    ]
  },
  {
    name: "Luis Quintana",
    ...
    location: "España",
    biography: [
      "Luis Quintana, maestro de la décima urbana radicado en España, representa un fenómeno único en el repentismo contemporáneo: la integración de temas contemporáneos con métrica clásica. Su estilo \"mulato viajero\" conocedor de lo barroco se ha impregnado de lo español, regresando a Cuba con riqueza expresiva única.",
      "Considerado sin discusión uno de los más grandes poetas repentistas cubanos de todos los tiempos, hay grandeza en su décima improvisada, que posee la lírica y la idea, el saber del hombre, sus caídas y la excelencia en la metáfora. Pero además tiene histrionismo, es artista y al mismo tiempo peleón.",
      "Tiene pinta de gladiador mientras controla su voz y hace uso de diferentes tonadas en los momentos apropiados para dar fuerza y agresividad o suavidad y ternura a lo que dice. Ha protagonizado controversias legendarias junto a Alexis Díaz Pimienta y Juan Antonio Díaz.",
      "Su capacidad de moverse entre registros—urbano y campesino, cubano y español, clásico y contemporáneo—lo distingue como uno de los improvisadores más respetados de la actualidad. Ha compartido escenario con Juan Antonio Díaz en múltiples ocasiones."
    ]
  },
  {
    name: "Yoslay García",
    ...
    biography: [
      "Yoslay García nació en 1978, natural de Matanzas. Representa la continuidad del arte en las nuevas generaciones y se erige como uno de los por poetas repentistas más importantes de su generación. La solidez de su décima lo distingue en el escenario.",
      ...
      "Junto a Oniesis Gil y otros jóvenes repentistas, constituye no sólo la vanguardia del repentismo cubano de principio del siglo XXI, sino las voces más alzadas de la nueva generación. Ha compartido escenario con figuras destacadas como Juan Antonio Díaz.",
      "Ha protagonizado controversias con Geovanis León y otros poetas de su generación, demostrando consistentemente su capacidad de construir décimas de gran profundidad con economía de recursos. Su estilo matancero—sólido, meditado, profundo—contrasta con estilos más teatrales."
    ]
  },
  {
    ...
    biography: [
      "Leandro Camargo Pérez nació en 1987 en Los Palacios, Pinar del Río. Joven y talentoso poeta, más conocido por su amplia y deslumbrante ejecutoria como repentista en los escenarios de la décima oral improvisada, es igualmente relevante en la investigación, la docencia y la escritura de la poesía.",
      "En 2007, con solo 20 años, alcanzó el Premio en el emblemático Concurso Nacional de Improvisación Justo Vega. Su precocidad creativa se manifestó desde los 14 años, cuando en 2001 actuó en el encuentro titulado \"La canturía más larga\". En 2010 ganó el concurso de repentismo Francisco Pereira.",
      "Una nueva generación de poetas como él le ha obsequiado a la décima la merced de la improvisación sobre temas históricos y patrióticos. Su décima \"La Bandera\" es un ejemplo magistral de poesía patriótica improvisada: \"Y no es que haya que adorarla / en sustitución de un dios, / es que hay que limpiar la voz / de sombras para nombrarla. / El que aprende a respetarla / sus orígenes no olvida...\"",
      "Ha demostrado también su dominio técnico en variantes difíciles como la seguidilla al revés en homenaje implícito a Alejo Carpentier. Su poesía combina el amor a la patria con una técnica impecable y profundidad emocional."
    ]
  },
  {
    name: "Oniesis Gil",
    ...
    biography: [
      ...
      "En una controversia memorable con Luis Quintana, Oniesis demostró su nivel extraordinario de improvisación. Han protagonizado una encendida controversia en homenaje a la popular improvisadora cubana Tomasita Quiala, evidenciando su compromiso con la tradición.",
  ...
  },
  {
    ...
    location: "Miami",
    biography: [
      "Manuel Soriano nació el 5 de mayo de 1947 en Bejucal, La Habana. Desde 1986 reside en Miami, donde se ha consolidado como una de las figuras más activas del repentismo en el exilio. Su iniciación en la poesía comenzó a los siete años recitando a José Martí.",
      "En el campo literario ha publicado cinco volúmenes notables: \"Vivencias\" (1999), \"Magia del Juego de Damas\" (2001), \"Quinientos Setenta y Nueve\" (2003), \"Mis Guantanameras\" (2005) y \"Noticias Rimadas\" (2007). Desde 2003 escribe diariamente las décimas de las guantanameras para un popular programa de televisión local.",
      "Es muy activo en el programa \"Clave Guajira\" del canal 41 América TV en Miami. Ha compartido controversias con Jesús Lazo, Pablo León, Guillermo Sosa Curbelo, Efraín Riverón, Asael Díaz \"Candelita\", Juan Antonio Díaz, Oniesis Gil y many otros maestros.",
