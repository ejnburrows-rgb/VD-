    ...
    <main className="tobacco-paper pb-16">
      <div className="pt-8 px-6 max-w-3xl mx-auto">
        ...
        <header className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-display font-black text-[#3e2814] mb-4">La Décima Espinela</h1>
        ...
        <article className="font-prose text-lg text-[#2a180a] leading-relaxed space-y-8">
          ...
          <p className="italic text-center text-[#6b4a25] mb-6">Travesía Atlántica: Semilla en Nuevo Suelo</p>
          <p>
          ...
          <p className="italic text-center text-[#6b4a25] mb-6">El Cucalambé: Cubanización Definitiva</p>
          <p>
          ...
          <p className="italic text-center text-[#6b4a25] mb-6">El Repentismo: Arte Nacional</p>
          <p>
          ...
          <p className="italic text-center text-[#6b4a25] mb-6">Momentos de Excelencia: La Controversia del Siglo (1955)</p>
          <p>
          ...
          <p className="italic text-center text-[#6b4a25] mb-6">UNESCO 2017: Patrimonio del Mundo</p>
          <p>
